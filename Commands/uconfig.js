...
exports.run = function(bot, message, args) {
    ...
    if (args.length == 0 || args.indexOf('help') != -1) {
        ...
        const embed = new Discord.RichEmbed()
            ...
            .setDescription(`Here are the different parameters you can change to have a better experience of ${bot.user.username}(Note: If setting is disabled in &gconfig by guild owner, these settings will be ignored.\nUsage Example : \`&uconfig healthMonitor off\`\n${description}`)
            .setColor('BLUE');
