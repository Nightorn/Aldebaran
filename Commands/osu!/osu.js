exports.run = (bot, message, args) => {
    ...
    if (args[0].toLowerCase() === '?') {
        const embed = new RichEmbed()
            ...
            .addField(`Supported Mods`, `**osu!standard** : BY DEFAULT, --osu\n**osu!taiko** : --taiko\n**osu!ctb** : --ctb\n**osu!mania** : --mania`)
            .setColor(`BLUE`);
        ...
        if (Nodesu.Mode[mode] !== undefined) {
            client.user.get(args[0], Nodesu.Mode[mode], undefined, 'string').then(data => {
                ...
                const embed = new RichEmbed()
                    ...
                    .addField(`Total Hits`, f(i(user.count300) + i(user.count100) + i(user.count50)), true)
