...
exports.run = async function(bot, message, args) {
    if (['310296184436817930', '320933389513523220', message.member.permissions.has('ADMINISTRATOR')].indexOf(message.author.id) == -1) return message.reply(`How about you not do that!`);
