		...
		connection.connect(connectionError => {
			if (connectionError) throw connectionError;
				...
				const promises = [
					...
					connection.query("CREATE TABLE `users` (\n  `userId` tinytext CHARACTER SET utf8 NOT NULL,\n  `settings` text CHARACTER SET utf8 NOT NULL,\n  `tfaKey` tinytext CHARACTER SET utf8,\n  `banned` tinyint(1) NOT NULL DEFAULT \'0\'\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin"),
					connection.query("CREATE TABLE `photogallery` (\n  `userid` tinytext CHARACTER SET utf8 NOT NULL,\n  `links` longtext CHARACTER SET utf8 NOT NULL,\n  `linkname` longtext CHARACTER SET utf8 NOT NULL,\n  `tags` varchar(45) CHARACTER SET utf8 NOT NULL,\n  `nsfw` tinytext CHARACTER SET utf8\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin"),
