exports.run = (client, message) => {
  ...
  if (message.author.id == `271394014358405121` ){
    ...
    if(message.content.endsWith(`a chance to claim it!`)) {
      message.channel.send(`Come Grab My Box <@310296184436817930> <@384996823556685824> <@266632489546678273> <@207575115616092161> <@226358525410934794> <@267906052366794753> <@348317596606529536> <@&440727495906689024>`)
    }
  }
